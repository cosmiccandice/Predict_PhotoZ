...
#SBATCH -N 1
#SBATCH -n 1
#SBATCH --array=0-413%40
#SBATCH --time=01-00:00:00
#SBATCH --mem=5G
#SBATCH --job-name="ps1dr2_catalog_convert"
#SBATCH --output=/home/mcs8686/jobs/sbatch_ps1dr2_conversion_job.%A_%a.txt
...
FILELIST=/projects/b1094/stroh/software/catalogs/ps1dr2/file_list.txt
...
/projects/b1094/software/catalogs/ps1dr2/ps1dr2_original_to_photoz_db.sh "${LINES[$SLURM_ARRAY_TASK_ID]}"
